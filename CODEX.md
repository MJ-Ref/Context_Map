...
> **Purpose:** Configuration and routing for OpenAI Codex sessions.
...
the patterns it teaches. When cloned as a template, it's a working example.
When read as documentation, every file is a live demonstration.
